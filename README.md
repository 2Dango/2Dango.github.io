...
A static, GitHub Pages-ready meeting poll with five answer buttons and a live bar chart. Each browser receives a stored participant ID and is placed directly into the poll. The host menu accepts `123456` to begin a new round.
